...
public class SPUDLMSimilarity extends SPUDLMBaseSimilarity {
    ...
    public SPUDLMSimilarity(SPUDLMBaseSimilarity.CollectionModel collectionModel) {
    ...
    protected void explain(Explanation expl, BasicStats stats, int doc,
        ...
        weightExpl.setValue((float) Math.log(1 + freq
                / (omega * ((SPUDLMBaseSimilarity.LMStats) stats).getPolyaCollectionProbability())));
    ...
    private class SPUDLMSimScorer extends Similarity.SimScorer {
